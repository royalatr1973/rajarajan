...
import { Instagram, Youtube, Mail, Heart, MessageCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-gold">Ajis Bakes</h3>
            <p className="text-cream text-sm leading-relaxed">
              Great Taste in Every Bite. Custom cakes crafted for every occasion.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a
                href="https://www.instagram.com/Ajis_bakes/"
                target="_blank"
              ...
              <a
                href="https://www.youtube.com/@ajis_homebakes"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gold/20 hover:bg-gold hover:text-cocoa-dark p-2 rounded-full transition-all duration-300"
              >
        ...
        <div className="border-t border-gold/30 mt-8 pt-8 text-center">
          <p className="text-cream text-sm flex items-center justify-center gap-2">
            © 2024 Ajis Bakes. Made with <Heart size={16} className="text-gold fill-gold" /> by Suganya Narayanasamy
          </p>
        </div>
      </div>
    </footer>
