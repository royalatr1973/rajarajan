-- Supabase Schema for Ajis Bakes
...
VALUES (
  1,
  'Custom cakes crafted for every occasion',
  'Great Taste in Every Bite! Make your celebrations sweeter with our delectable homemade cakes from Ajis Bakes.',
  'Order Now',
