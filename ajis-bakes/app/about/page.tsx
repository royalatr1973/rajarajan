          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-cocoa-medium leading-relaxed">
                Welcome to Ajis Bakes! I'm Suganya Narayanasamy, and my passion for baking
                started in my home kitchen in Chennai. What began as a love for creating
                beautiful, delicious cakes for family and friends has grown into Ajis Bakes --
                a place where every cake is crafted with care for your special occasions.
              </p>
              <p className="text-lg text-cocoa-medium leading-relaxed">
                At Ajis Bakes, every cake is handmade with premium ingredients and attention
                to detail. We use only the finest quality ingredients -- no artificial flavors,
                no preservatives, just pure, delicious cakes made fresh to order.
              </p>
              <p className="text-lg text-cocoa-medium leading-relaxed">
                "Custom cakes crafted for every occasion" -- whether it's a birthday, wedding,
                anniversary, or any celebration, we bring great taste in every bite. Contact us
                via WhatsApp or Instagram to place your order!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-cocoa-medium">
                A home-based business in Chennai dedicated to bringing joy through cakes.
              </p>
            </div>
          </div>
        </div>
