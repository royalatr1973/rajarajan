      ...
      <main className="pt-16">
        <section className="bg-gradient-to-br from-cocoa-dark via-cocoa-medium to-cocoa-dark py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-cream mb-4">Our Products</h1>
            <p className="text-cream/70 text-lg max-w-2xl mx-auto">
              Explore our complete range of homemade treats across five delicious categories
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <button
                ...
                className={`px-5 py-2 rounded-xl font-medium transition-all duration-200 ${
                  activeCategory === 'all'
                    ...
                    : 'bg-white text-cocoa-medium hover:bg-gold-light'
                }`}
              >
                All ({products.length})
              </button>
            ...
            {loading ? (
              <div className="text-center py-20">
                ...
                <p className="text-cocoa-medium mt-4">Loading products...</p>
              </div>
            ) : filtered.length === 0 ? (
              <div className="text-center py-20">
                <p className="text-cocoa-medium text-lg">No products found in this category.</p>
              </div>
            ) : (
