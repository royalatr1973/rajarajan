    ...
    <section className="py-20 bg-cream-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-silk-dark mb-4">Our Collections</h2>
          <p className="text-silk-light text-lg max-w-2xl mx-auto">
            Explore our five exquisite collections of handwoven silk sarees
          </p>
        </div>
          ...
          {ALL_CATEGORIES.map((cat) => {
            ...
            return (
              <Link key={cat} href={`/products/${cat}`}
                ...
                <h3 className="text-silk-dark font-semibold text-lg mb-2">{info.label}</h3>
                <p className="text-silk-light text-sm leading-relaxed">{info.description}</p>
              </Link>
            )
          })}
        </div>
