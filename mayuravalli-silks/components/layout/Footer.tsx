...
import { Phone, Mail, MapPin, Clock, Instagram, Youtube, Facebook, MessageCircle, Gem } from 'lucide-react'
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-silk-dark via-silk-dark to-black text-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-cream/70 text-sm leading-relaxed">{settings.tagline}. Bringing you the finest handwoven silk sarees direct from the looms of Kanchipuram.</p>
            {/* Social Links */}
            <div className="flex gap-3 mt-4">
              {settings.whatsapp && (
                <a href={`https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer"
                  className="bg-silk-medium hover:bg-gold text-cream hover:text-silk-dark p-2 rounded-lg transition-all duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/products" className="text-cream/70 hover:text-gold transition-colors text-sm">All Collections</Link></li>
          ...
          {/* Collections */}
          <div>
            <h3 className="text-gold font-semibold text-lg mb-4">Our Collections</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-silk-medium mt-8 pt-6 text-center text-cream/50 text-sm">
          <p>&copy; {new Date().getFullYear()} {settings.business_name}. All rights reserved. | Worldwide Shipping Available</p>
        </div>
      </div>
    </footer>
  )
