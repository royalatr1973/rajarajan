...
-- Allow authenticated insert/update/delete (for admin panel)
...
CREATE POLICY "Allow authenticated insert on testimonials" ON testimonials FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow authenticated update on testimonials" ON testimonials FOR UPDATE USING (true);
CREATE POLICY "Allow authenticated delete on testimonials" ON testimonials FOR DELETE USING (true);

CREATE POLICY "Allow authenticated insert on hero" ON hero FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow authenticated update on hero" ON hero FOR UPDATE USING (true);
CREATE POLICY "Allow authenticated delete on hero" ON hero FOR DELETE USING (true);

-- Seed data: Products - Cakes
INSERT INTO products (id, name, description, category, type, image, is_featured, is_best_seller, display_order) VALUES
